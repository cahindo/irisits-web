  ...
  <div class="container">
    ...
    <div class="row justify-content-md-center text-center" id="teamContainer">
      ...
      <div class="col-sm-6 col-lg-3 mb-4 mb-lg-0 element-item {{ $member->division }}">
        <div class="chef-card">
          @if (file_exists(public_path('iris/member/'.$member->name.'.png')))
            <img class="card-img rounded-0" src="{{ asset('iris/member/'.$member->name.'.png') }}" alt="">      
          @else
            <img class="card-img rounded-0" src="{{ asset('iris/member/default.png') }}" alt="">        
          @endif
